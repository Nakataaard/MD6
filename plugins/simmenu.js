 ...
 *Powered By @${'6285748894171'.split('@')[0]}*` 
...
const fkgif = {
	 ...
	 { remoteJid: "6285748894171-1625305606@g.us" } : {}) 
                },
	 message: { 
		"extendedTextMessage": {
                 "text":`NahBotz- MD 🌱 ┊ 𝗥𝗣𝗚 Whatsapp ʙᴏᴛ`,
                 "title": `NahBotz- MD 🌱 ┊ 𝗥𝗣𝗚 Whatsapp ʙᴏᴛ`,
                 'jpegThumbnail': await (await fetch('https://telegra.ph/file/870d45493ab30515e99a1.jpg')).buffer()
                        }
	                  } 
                     }
...
●────━───༺༻───━────●
                *《 BOT INFO 》*
⚘ *Bot Name: NahBotz*
⚘ *Creator: Stah NakataSan*
⚘ *Contact Owner Bot*
*http://wa.me/6285748894171*
⚘ *Tanggal: ${date}*  
⚘ *Jam: ${time} WIB*
⚘ *Status: 「 ${mode} 」*
⚘ *Prefix: 「 MULTI PREFIX 」*
 ...
       const sections = [
                              {
                                "rows": [{
                                         "title": "📊 › Status ",
                                         "description": "Status カ NahBotz MD",
                                         "rowId": ".botstat"
                                    }, {
                                         "title": "⚡› Speed ",
                                         "description": "Menampilkan Kecepatan Respon カ NahBotz",
                                         "rowId": ".ping"
                                    }, {
                                         "title": "🗒️› Info ",
                                         "description": "Menampilkan Info カ NahBotz",
                                         "rowId": ".info"
                                    }, {
                                         "title": "🎐 › Developer Bot ",
                  ...
                  "rowId": ".? owner"
                                ...
                                "description": "Last Update Terakhir Di NahBotz",
                                "rowId": ".notes"                  
                }],                
                                "title": "▮Last Update 」"
                                }, {
