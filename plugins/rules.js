...
`.trim(), 'Kebijakan ©2022 By NakataSan', '⋮☰ Menu', '.menu', 'Owner', '.nowner', 'Donasi', '.donasi', m, {
    quoted: m,
    contextInfo: {
        externalAdReply: {
            ...
            mediaType: 2,
          thumbnail: await (await fetch('https://telegra.ph/file/e70a08853e8bc639ebe89.jpg')).buffer(),
         mediaUrl: `https://instagram.com/nakataa1.a`
        }
     }
    })
handler.help = ['rules']
