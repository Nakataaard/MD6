 ...
 *Official Bot @${'6285162634171'.split('@')[0]}* 
 *Powered By @${'628574889171'.split('@')[0]}*`
 ...
 const ftroli = {
    ...
    status: 1,
    surface : 1,
    message: `NahBotz- By NakataArdnta`, 
    orderTitle: `▮Menu ▸`,
 ...
     }) 
     if (teks == '404') {
 	let cute = `${pickRandom(['https://telegra.ph/file/cbd1152f6f558ec009626.jpg', 'https://telegra.ph/file/46a881392c0262fdfc3a1.jpg', 'https://telegra.ph/file/e70a08853e8bc639ebe89.jpg', 'https://telegra.ph/file/76482c95324225d3ff61f.jpg'])}` 
 	let ori = `Hi Kak, @${m.sender.split`@`[0]}
 
Saya Adalah NahBotz Salah Satu Bot Whatsapp Yang Siap Membantu Kamu Mempermudah Sesuatu Seperti Membuat Sticker Dan Lainnya, Kalo Kamu Mau Request Fitur Silahkan Ketik #request Pesan Atau Fitur Yang Kamu Inginkan!`
...
                 .replace(/%islimit/g, menu.limit ? 'Ⓛ' : '')
 ...
     //await conn.reply(m.chat, '*L o a d i n g . . .*', fload) 
   ...
   /*await conn.send2ButtonImg(m.chat, await (await fetch('https://api.xteam.xyz/textpro/glitch?text=' + teks + '&text2=Nah%20Botz%20BY%20Nakata%20SAN&APIKEY=bf8ff984af1506b7')).buffer(), text.trim(), hao, 'Donasi', '.donasi', 'Rules', '.rules', m, { 
     quoted: ftoko, 
     contextInfo: { forwardingScore: 99999, isForwarded: true, 
         externalAdReply: { 
             title: 'NahBotz Testing Project By Nakata San', 
 ...
      } 
     })*/
//await conn.send3ButtonLoc(m.chat, await conn.resize(await (await fetch('https://api.xteam.xyz/textpro/glitch?text=' + teks + '&text2=Nah%20Botz%20BY%20Nakata%20SAN&APIKEY=bf8ff984af1506b7')).buffer(), 300, 200), '◈┈┉────[ *DASHBOARD* ]────┉┈◈' , text.trim(), 'Owner', '.owner', 'Donasi', '.donasi', 'Rules', '.rules', m)
...
type: 'audioMessage', 
ptt: true, contextInfo:{ externalAdReply: { title: `💌 Ultah Nakata : ${ohari} Hari ${ojam} Jam ${onet} Menit ${detek} Detik`, body: `${pickRandom(['Follow Instagram Saya'])}`, sourceUrl: 'https://instagram.com/nakataa1.a', thumbnail: await (await fetch('https://telegra.ph/file/cbd1152f6f558ec009626.jpg')).buffer(),}} 
     })
} catch (e) { 
