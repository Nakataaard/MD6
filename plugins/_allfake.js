...
handler.all = async function (m) {
	...
	try {
	 ...
	 { remoteJid: "6285748893171-1625305606@g.us" } : {}) 
                },
	 message: { 
		"audioMessage": {
	 ...
	 message: { "liveLocationMessage": { "caption":"by : Nakata","h": `${wm}`, 'jpegThumbnail': fs.readFileSync('./src/logo.jpg')}}
	}
...
key: {
			fromMe: false,
			participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "6285748893171@s.whatsapp.net" } : {})
		},
		message: {
			"productMessage": {
				"product": {
	...
	"message": {
		"groupInviteMessage": {
			"groupJid": "6285748893171-1625305606@g.us",
			"inviteCode": "null",
