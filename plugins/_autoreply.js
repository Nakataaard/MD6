let fs = require('fs') 
 ...
     } 
      
     if (/@6285748894171$/i.test(m.text)) { 
 ...
         externalAdReply: { 
                 sourceUrl: 'https://instagram.com/nakataa1.a', 
             title: 'NakataArdnta', 
             body: '', 
 ...
        await this.setBio(`☘️ Ultah NakataSan : ${ohari} Hari ${ojam} Jam ${onet} Menit ${detek} Detik
⏲️ Runtime: ${uptime} | 🛰 Mode: ${global.opts['self'] ? 'Private' : setting.groupOnly ? 'Only Group' : 'Public'} | 💌 Made by Nakata`).catch(_ => _)  
