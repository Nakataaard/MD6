...
*Powered By @${global.owner[1].split('@')[0]}*`
    ...
        await conn.send3ButtonLoc(m.chat, 'https://telegra.ph/file/cbd1152f6f558ec009626.jpg', ` ${ucapan()}, @${m.sender.split`@`[0]}
 ${user.banned ? 'kamu dibanned' : `
Saya Adalah, NahBotz What'sapp Yang Bisa Anda Gunakan Untuk Membuat Sticker, Mendownload Sesuatu, Bermain Game, Dll.
